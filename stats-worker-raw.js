...
function getCombo(...args) {
  ...
  if (args.length === 2) return new Combo(...args);      // From part IDs
...
const bodyVariants = {
  std: {
    ...
    daisy: "daisy",
    yoshi: "yoshi",
      "yoshi-touring": "shyguy",
      "yoshi-pro": "",
      "yoshi-aristocrat": "pauline",
      "yoshi-ice": "toadette",
      "yoshi-biker": "toad",
      "yoshi-swim": "lakitu",
      "yoshi-festival": "kingboo",
      "yoshi-food": "daisy",
    dk: "dk",
    bowser: "bowser",
    bowserJr: "bowserJr",
  ...
  royale: {
    ...
    daisy: "daisy",
    yoshi: "rosalina",
      "yoshi-touring": "rosalina",
      "yoshi-pro": "",
      "yoshi-aristocrat": "",
      "yoshi-ice": "",
      "yoshi-biker": "rosalina",
      "yoshi-swim": "daisy",
      "yoshi-festival": "luigi",
      "yoshi-food": "daisy",
    dk: "daisy",
    bowser: "daisy",
    bowserJr: "daisy",
  ...
  biddy: {
    ...
    daisy: "yellow",
    yoshi: "green",
      "yoshi-touring": "yellow",
      "yoshi-ice": "pink",
      "yoshi-biker": "blue",
      "yoshi-swim": "yellow",
      "yoshi-festival": "yellow",
      "yoshi-food": "yellow",
    bowser: "yellow",
    bowserJr: "yellow",
    koopa: "green",
  ...
  pipe: {
    ...
    daisy: "daisy",
    yoshi: "yoshi",
      "yoshi-touring": "kingboo",
      "yoshi-pro": "",
      "yoshi-aristocrat": "shyguy",
      "yoshi-ice": "peach",
      "yoshi-biker": "toad",
      "yoshi-swim": "lakitu",
      "yoshi-festival": "koopa",
      "yoshi-food": "daisy",
    dk: "dk",
    bowser: "daisy",
    bowserJr: "daisy",
